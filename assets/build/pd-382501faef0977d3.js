...
{ name: 'LEGGIMI.txt', text: 'Backup Pido Darts v1.0.4.1. Per ripristinarlo usa Impostazioni > Dati e backup > Importa backup.\n' }
];
...
? 'PARTITA · MULTIPLAYER v1.0.4.1'
: (isComputerMatch()
? `PARTITA · VS PIDO PC · ${computerDifficultyLabel(state.computerDifficulty).toUpperCase()}`
: (isIdealChallenge() ? 'PARTITA · RECORD IDEALE v1.0.4.1' : (isRecordChallenge() ? 'PARTITA · BATTI IL RECORD v1.0.4.1' : 'PARTITA · ALLENAMENTO v1.0.4.1')));
}
