...
{ name: 'LEGGIMI.txt', text: 'Backup Pido Darts v1.0.4.2. Per ripristinarlo usa Impostazioni > Dati e backup > Importa backup.\n' }
];
...
? 'PARTITA · MULTIPLAYER v1.0.4.2'
: (isComputerMatch()
? `PARTITA · VS PIDO PC · ${computerDifficultyLabel(state.computerDifficulty).toUpperCase()}`
: (isIdealChallenge() ? 'PARTITA · RECORD IDEALE v1.0.4.2' : (isRecordChallenge() ? 'PARTITA · BATTI IL RECORD v1.0.4.2' : 'PARTITA · ALLENAMENTO v1.0.4.2')));
}
